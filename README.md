...
GEM is an autonomous physical desk companion featuring interactive touch sensors, animated OLED eyes, Wi-Fi sync, 4 White LED ambient bulbs, Piezo audio buzzer for sound alerts & touch feedback, custom low-latency firmware, and optional biometric pulse & motion telemetry in v2 Pro.
...
| **Audio Alert & Chimes** | **Piezo Audio Buzzer** | **Piezo Audio Buzzer** (Pulse & Touch Synced) |
...
```
GEM/
├── GEM_v1_Firmware/             # Base firmware (4 White LEDs + Touch + OLED + Buzzer + 1000mAh)
│   ├── GEM_v1_Firmware.ino
│   ├── GemBuddyConfig.h
│   └── eyes.h
├── GEM_v2_Firmware/             # Pro firmware (MAX30102 Heart Sensor + IR Motion + 4 White LEDs + Buzzer + 1500mAh)
│   ├── GEM_v2_Firmware.ino
│   ├── GemBuddyConfig.h
│   └── eyes.h
